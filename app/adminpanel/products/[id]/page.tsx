        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Description (HTML) - Use o editor abaixo para formatar o conteúdo
            </label>
            <RichTextEditor
              content={product.description || ''}
              onChange={(html) => setProduct({ ...product, description: html })}
              placeholder="Digite a descrição do produto aqui. Use os botões da toolbar para formatar o texto..."
            />
